...
program
  ...
  .option('-d, --dir <path>', 'Directory with your pdf templates', './pdfs')
...
program
  ...
  .option('-d, --dir <path>', 'Directory with your skrift pdf templates', './pdfs')
  .option(
...
program
  ...
  .option('-d, --dir <path>', 'Directory with your email templates', './pdfs')
  .option(
    '-s, --silent',
